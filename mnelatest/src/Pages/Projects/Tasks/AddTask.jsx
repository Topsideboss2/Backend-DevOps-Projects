...
import CreateTasksAction from '../../../Redux/Actions/Task/AddTaskAction';
...
export default function AddTask({handleAddedMilestone}) {
    const dispatch=useDispatch()
    const loading=useSelector(state=>state.createTask.loading)
    const addedTask=useSelector(state=>state.createTask.data)
    ...
    const onInputChange = (e) => {
      ...
      const postTask=()=>{
        ...
        dispatch(CreateTasksAction(data))
        handleAddedMilestone(addedTask,loading)
        
      }

    return (
        <div>
            <Button variant="outlined" startIcon={<Add />} style={{ color: "#00a15d" }} size="large" onClick={handleOpen}>Add Task</Button>
            <Modal
                open={open}
                onClose={handleClose}
