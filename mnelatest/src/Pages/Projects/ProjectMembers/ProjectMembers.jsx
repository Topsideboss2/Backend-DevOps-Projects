...
const ProjectMembersTable = ({isShown, toogle,newMember}) => {
  ...
  setPage(0);
    ...
    useEffect(() => {
      ...
      setAddedMembers([...companyMembers,newMember])
        ...
        console.log("company roles",roles)
                
    }, [roleId,newMember])
  return (
    <Card>
      <Box class="right-side m-4">
        <AddProjectMembers projectId={id}/>
...
export default WithToggle(ProjectMembersTable);
