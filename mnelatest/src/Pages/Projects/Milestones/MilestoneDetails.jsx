...
export default function MilestoneDetails({projectName}) {
    const [value, setValue] = React.useState(0);
    const dispatch = useDispatch()
    const { id, milestoneId } = useParams()
    const milestone = useSelector(state => state.milestone.data) ?? {}
    const milestoneReport=useSelector(state => state.milestone.data) ?? {}
    function handleChange(event, newValue) {
        setValue(newValue);
    }
    console.log("milestone",milestone)
    useEffect(() => {
        dispatch(GetSingleMilestoneAction(milestoneId))
    }, [])
    return (
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8">
            {/* <BreadCrumb companyName={"Company A"} projectId={id}  milestoneId={milestoneId} milestoneName={milestone.title}/> */}
                <div class="row">
                    <div class="col-xl-12">
                                ...
                                <>
                                    <div class="row border-bottom pb-5">
                                        <div class="col-xl-12 col-lg-12">
                                            <div class="p-1">
                                                <h4 class="fs-32 font-w700">{milestone.title}</h4>
                                                <span class="mb-2 d-block">Created  on {moment(milestone.created_at).format('MMMM DD YYYY')}</span>
                                                    ...
                                                    <TabPanel value={value} index={0}>
                                                        <>
                                                            <div class="project-description p-2">
                                                                <span class="fs-18 font-w500 mb-3 d-block">Milestone Description</span>
                                                                ...
                                                                <Grid container spacing={2}>
                                                                    ...
                                                                    <Grid item xs={12} sm={6}>
                                                                        ...
                                                                        <ListItem>
                                                                            ...
                                                                            <ListItemText primary="Start Date" secondary={moment(milestone.start_date).format('MMMM DD YYYY')} />
                                                                        </ListItem>
                                                                        <ListItem>
                                                                            <ListItemAvatar>
                                                                                <Avatar>
                                                                            ...
                                                                            <ListItemText primary="Due Date" secondary={moment(milestone.end_date).format('MMMM DD YYYY')} />
                                                                        </ListItem>
                                                                    ...
                                                                    <Grid item xs={12} sm={6}>
                                                                        ...
                                                                        <ListItem>
                                                                            ...
                                                                            <ListItemText primary="Amount Spent" secondary={milestone.actual_cost == null ? `0` : milestone.actual_cost} />
                                                                        </ListItem>
                                                                        <ListItem>
                                                                            <ListItemAvatar>
                                                                                <Avatar>
                                                                            ...
                                                                            <ListItemText primary="Estimated  Cost" secondary={milestone.estimated_cost} />
                                                                        </ListItem>
                                                                    </Grid>
                    ...
                    <div class="card">
                        <div class="card-body px-4">
                            ...
                            <div class="progress default-progress">
                                <div class="progress-bar progress-animated" style={{ width: `${milestone.completion_percent}==null?${0}:${milestone.completion_percent}`, height: "10px" }} role="progressbar">
                                    <span class="sr-only">{milestone.completion_percent==null?0:milestone.completion_percent} `% Complete</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-end mt-1 justify-content-between">
                                <span><small class="text-primary">{milestone.completion_percent==null?0:milestone.completion_percent}</small> % Completed</span>
